<?php /* Form đa bước Enepi */ ?>
<div class="w-full min-h-screen bg-[url('/images/background.png')] bg-repeat">
    <div class="w-full max-w-[960px] mx-auto pt-10">
        ...
        <p class="text-xs text-brown text-center font-normal py-4">※削減金額は条件により異なります</p>
    </div>
